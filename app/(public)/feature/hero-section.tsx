import { ArrowRight, Check, Download, FileText, ShieldCheck, User } from 'lucide-react';
            ...
            <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-24">
                <div>
                    ...
                    <p className="mt-6 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">
                        O MeuLaudo conecta clínicas, laboratórios e pacientes em uma entrega digital
                        simples, segura e sem papel. Menos espera no balcão, mais agilidade para
                ...
                <div className="relative mx-auto w-full max-w-xl">
                        ...
                        <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500">Protocolo ML-2026-1048</p>
                                </div>
                            </div>
                    ...
                    <div className="absolute -bottom-8 -left-5 hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-lg sm:block">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-sm font-bold text-slate-900">Dados protegidos</p>
